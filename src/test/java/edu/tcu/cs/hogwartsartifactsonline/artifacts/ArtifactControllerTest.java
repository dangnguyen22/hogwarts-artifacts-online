    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        ArtifactDto artifactDto = new ArtifactDto(null,"Remembrall",
                "A Remembrall was a magical large marble-sized glass ball that " +
                        "contained smoke which turned red when its owner or user had forgotten something." +
                        " It turned clear once whatever was forgotten was remembered.","ImageUrl",null);
...
//Given
        ArtifactDto artifactDto = new ArtifactDto(eq("1250808601744904192"),"Invisibility Cloak",
    ...
    @Test
    void testDeleteArtifactSuccessful() throws Exception {
        //Given
