...
public class ExceptionHandlerAdvice {
    ...
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    Result handleInsufficientAuthenticationExeception(InsufficientAuthenticationException ex){
    ...
    Result handleInvalidBearerTokenException(InvalidBearerTokenException ex){
        return new Result(false, StatusCode.UNAUTHORIZED,"The access token provided expired, revoked, malformed, or invalid for other reasons.", ex.getMessage());
    }
